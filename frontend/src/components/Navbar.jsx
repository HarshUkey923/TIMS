        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <div
              ...
              {role === "HR" && <span style={{ color: "white", fontSize: "12px", fontWeight: "700" }}>HR</span>}
              {role === "Mentor" && <span style={{ color: "white", fontSize: "12px", fontWeight: "700" }}>Mentor</span>}
              {role === "Intern" && <span style={{ color: "white", fontSize: "12px", fontWeight: "700" }}>Intern</span>}
            </div>


        <button onClick={logout} className="btn btn-error btn-sm border-r-4">Logout</button>
          </div>
        </div>
